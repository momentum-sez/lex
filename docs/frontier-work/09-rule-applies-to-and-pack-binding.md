...
execution-host authors

Canonical public reference: `docs/language-reference.md`

Companion proposal: `docs/proposal-lex-rule-contract-and-pack-binding.md in the public Op repository`
...
curator authority; that is execution-host concern. The Lex programme
...
Curators that miss the deadline ship empty packs. This is the explicit-cutover shape: soft cutover with teeth, not soft cutover indefinitely.
...
2. **Curator authority.** Pack curator authority is execution-host
...
- **Conjectural.** Curator authority semantics; deferred to companion
  proposal and to the execution-host adopter.
