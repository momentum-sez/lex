...
Scope: typed frontier model for the nine core-calculus commitments
...
where evaluation must stop for human judgment. core-calculus commitments specifies nine
